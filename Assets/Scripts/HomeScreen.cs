...
#if UNITY_IOS
    private const string InterstitialAdUnitId = "6d318f954e2630a8";
    private const string RewardedAdUnitId = "e0b0d20088d60ec5";
    private const string RewardedInterstitialAdUnitId = "e0b0d20088d60ec5";
    private const string BannerAdUnitId = "34686daf09e9b052";
    private const string MRecAdUnitId = "";
#else // UNITY_ANDROID
    private const string InterstitialAdUnitId = "43395ac04e228cc7";
    private const string RewardedAdUnitId = "c9e2d5925100354c";
    private const string RewardedInterstitialAdUnitId = "c9e2d5925100354c";
    private const string BannerAdUnitId = "4c659b0149dbfbae";
    private const string MRecAdUnitId = "";
#endif
