...
{
    public class InterstitialTestLogic : InterstitialLogic
    {
        ...
        public void Initialize(string adUnitIdA, string adUnitIdB)
        {
        ...
        {
            OnAdLoadedCallback(adUnitId, SimulatorUi.GetAdInfo(adUnitId, "INTER", revenue));
        }
    }
}